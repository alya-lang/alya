...
pub fn emit(out: &mut String, os: OperatingSystem) {
    ...
    out.push_str("    movq 8(%r14, %rbx, 8), %rsi\n");
    out.push_str("    testq %rsi, %rsi\n");
    out.push_str("    jnz .L_x64_args_copy_init\n");
    out.push_str("    lea alya_str_empty(%rip), %rax\n");
    out.push_str("    jmp .L_x64_args_store\n");
    out.push_str(".L_x64_args_copy_init:\n");
    super::emit_str_buf_ctx(out, os);
    out.push_str("    mov (%r9), %rdi\n");
    out.push_str("    cmp $950000, %rdi\n");
    out.push_str("    jb .L_x64_args_buf_ok\n");
    out.push_str("    xor %rdi, %rdi\n");
    out.push_str(".L_x64_args_buf_ok:\n");
    out.push_str("    lea (%r8, %rdi), %rdx\n");
    out.push_str("    mov %rdx, %rax\n");
    out.push_str(".L_x64_args_copy_str:\n");
    out.push_str("    movb (%rsi), %cl\n");
    out.push_str("    movb %cl, (%rdx)\n");
    out.push_str("    testb %cl, %cl\n");
    out.push_str("    jz .L_x64_args_copy_done\n");
    out.push_str("    inc %rsi\n");
    out.push_str("    inc %rdx\n");
    out.push_str("    jmp .L_x64_args_copy_str\n");
    out.push_str(".L_x64_args_copy_done:\n");
    out.push_str("    inc %rdx\n");
    out.push_str("    sub %r8, %rdx\n");
    out.push_str("    add $7, %rdx\n");
    out.push_str("    and $-8, %rdx\n");
    out.push_str("    mov %rdx, (%r9)\n");
    out.push_str(".L_x64_args_store:\n");
