...
pub fn emit(out: &mut String, os: OperatingSystem) {
    ...
    out.push_str("    jb .L_x86_copy2_start\n");
    ...
    out.push_str("    cmp $65536, %esi\n");
    out.push_str("    jb .L_x86_concat_end\n");
    ...
    out.push_str("    cmp $65536, %edx\n");
    out.push_str("    jb .L_x86_chr_3b\n");
    out.push_str("    mov %edx, %esi\n");
    out.push_str("    shr $18, %esi\n");
    out.push_str("    add $0xF0, %esi\n");
    out.push_str("    mov %edx, %ecx\n");
    out.push_str("    shr $12, %ecx\n");
    out.push_str("    and $63, %ecx\n");
    out.push_str("    add $0x80, %ecx\n");
    out.push_str("    shl $8, %ecx\n");
    out.push_str("    or %esi, %ecx\n");
    out.push_str("    mov %edx, %esi\n");
    out.push_str("    shr $6, %esi\n");
    out.push_str("    and $63, %esi\n");
    out.push_str("    add $0x80, %esi\n");
    out.push_str("    shl $16, %esi\n");
    out.push_str("    or %esi, %ecx\n");
    out.push_str("    and $63, %edx\n");
    out.push_str("    add $0x80, %edx\n");
    out.push_str("    shl $24, %edx\n");
    out.push_str("    or %ecx, %edx\n");
    out.push_str("    mov $4, %eax\n");
    out.push_str("    jmp .L_x86_chr_write\n");
    out.push_str(".L_x86_chr_3b:\n");
    out.push_str("    mov %edx, %esi\n");
    out.push_str("    shr $12, %esi\n");
    out.push_str("    add $0xE0, %esi\n");
    out.push_str("    mov %edx, %ecx\n");
    out.push_str("    shr $6, %ecx\n");
    out.push_str("    and $63, %ecx\n");
    out.push_str("    add $0x80, %ecx\n");
    out.push_str("    shl $8, %ecx\n");
    out.push_str("    or %esi, %ecx\n");
    out.push_str("    and $63, %edx\n");
    out.push_str("    add $0x80, %edx\n");
    out.push_str("    shl $16, %edx\n");
    out.push_str("    or %ecx, %edx\n");
    out.push_str("    mov $3, %eax\n");
    out.push_str("    jmp .L_x86_chr_write\n");
    out.push_str(".L_x86_chr_2b:\n");
    out.push_str("    mov %edx, %esi\n");
    out.push_str("    shr $6, %esi\n");
    out.push_str("    add $0xC0, %esi\n");
    out.push_str("    and $63, %edx\n");
    out.push_str("    add $0x80, %edx\n");
    out.push_str("    shl $8, %edx\n");
    out.push_str("    or %esi, %edx\n");
    out.push_str("    mov $2, %eax\n");
    out.push_str("    jmp .L_x86_chr_write\n");
    out.push_str(".L_x86_chr_1b:\n");
    out.push_str("    mov $1, %eax\n");
    out.push_str("    jmp .L_x86_chr_write\n");
    out.push_str(".L_x86_chr_ptr:\n");
    out.push_str("    movzbl (%edx), %edx\n");
    out.push_str("    and $255, %edx\n");
    out.push_str("    jz .L_x86_chr_end\n");
    out.push_str("    mov $1, %eax\n");
    out.push_str(".L_x86_chr_write:\n");
    ...
    out.push_str("    pop %esi\n");
    out.push_str("    movb %dl, (%edi)\n");
    out.push_str("    cmp $2, %esi\n");
    out.push_str("    jb .L_x86_chr_adv\n");
    out.push_str("    shr $8, %edx\n");
    out.push_str("    movb %dl, 1(%edi)\n");
    out.push_str("    cmp $3, %esi\n");
    out.push_str("    jb .L_x86_chr_adv\n");
    out.push_str("    shr $8, %edx\n");
    out.push_str("    movb %dl, 2(%edi)\n");
    out.push_str("    cmp $4, %esi\n");
    out.push_str("    jb .L_x86_chr_adv\n");
    out.push_str("    shr $8, %edx\n");
    out.push_str("    movb %dl, 3(%edi)\n");
    out.push_str(".L_x86_chr_adv:\n");
    out.push_str("    movb $0, (%edi, %esi)\n");
    out.push_str("    lea 1(%edi, %esi), %edi\n");
    out.push_str("    sub %ecx, %edi\n");
    out.push_str("    add $3, %edi\n");
    out.push_str("    and $-4, %edi\n");
    emit_str_buf_store(out, "%edi", "%edx", os);
    ...
    out.push_str("    jb .L_x86_str_chk_argv\n");
    out.push_str("    lea alya_rodata_end, %ecx\n");
    out.push_str("    cmp %ecx, %eax\n");
    out.push_str("    jae .L_x86_str_chk_argv\n");
    out.push_str("    pop %esi\n");
    out.push_str("    pop %edi\n");
    out.push_str("    pop %ebx\n");
    out.push_str("    mov %ebp, %esp\n");
    out.push_str("    pop %ebp\n");
    out.push_str("    ret\n");
    out.push_str(".L_x86_str_chk_argv:\n");
    out.push_str("    mov alya_argc, %ecx\n");
    out.push_str("    test %ecx, %ecx\n");
    out.push_str("    jz .L_x86_str_convert\n");
    out.push_str("    mov alya_argv, %edx\n");
    out.push_str("    test %edx, %edx\n");
    out.push_str("    jz .L_x86_str_convert\n");
    out.push_str("    xor %ebx, %ebx\n");
    out.push_str(".L_x86_str_argv_loop:\n");
    out.push_str("    cmp %ecx, %ebx\n");
    out.push_str("    jge .L_x86_str_convert\n");
    out.push_str("    cmp (%edx, %ebx, 4), %eax\n");
    out.push_str("    je .L_x86_str_ret_direct\n");
    out.push_str("    inc %ebx\n");
    out.push_str("    jmp .L_x86_str_argv_loop\n");
    out.push_str(".L_x86_str_ret_direct:\n");
    out.push_str("    pop %esi\n");
    out.push_str("    pop %edi\n");
    out.push_str("    pop %ebx\n");
    out.push_str("    mov %ebp, %esp\n");
    ...
    out.push_str(".L_x86_s2i_chk_rodata:\n");
    out.push_str("    lea alya_rodata_start, %edx\n");
    out.push_str("    cmp %edx, %esi\n");
