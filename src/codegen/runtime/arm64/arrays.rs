...
pub fn emit(out: &mut String, os: OperatingSystem) {
    ...
    out.push_str("    b.lo .L_arm64_fn_slice_chk_str_buf\n");
    emit_adrp_add(out, "x4", "alya_rodata_end", os);
    out.push_str("    cmp x0, x4\n");
    out.push_str("    b.lo .L_arm64_fn_slice_str\n");
    out.push_str(".L_arm64_fn_slice_chk_str_buf:\n");
    emit_adrp_add(out, "x3", "alya_str_buf", os);
    out.push_str("    cmp x0, x3\n");
    out.push_str("    b.lo .L_arm64_fn_slice_chk_tag\n");
    out.push_str("    movz x4, #1024, lsl #16\n");
    out.push_str("    add x4, x3, x4\n");
    out.push_str("    cmp x0, x4\n");
    out.push_str("    b.lo .L_arm64_fn_slice_str\n");
