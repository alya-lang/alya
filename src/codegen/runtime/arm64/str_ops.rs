...
pub fn emit(out: &mut String, os: OperatingSystem) {
    ...
    out.push_str("    b.ls .L_arm_copy2_start\n");
    ...
    out.push_str("    b.ls .L_arm_concat_end\n");
    ...
    out.push_str("    b.ls .L_arm_len_end\n");
    out.push_str("    tst x1, #7\n");
    out.push_str("    b.ne .L_arm_len_loop\n");
    emit_adrp_add(out, "x2", "alya_rodata_start", os);
    out.push_str("    cmp x1, x2\n");
    out.push_str("    b.lo .L_arm_len_chk_str_buf\n");
    emit_adrp_add(out, "x3", "alya_rodata_end", os);
    out.push_str("    cmp x1, x3\n");
    out.push_str("    b.lo .L_arm_len_loop\n");
    out.push_str(".L_arm_len_chk_str_buf:\n");
    emit_adrp_add(out, "x2", "alya_str_buf", os);
    out.push_str("    cmp x1, x2\n");
    out.push_str("    b.lo .L_arm_len_chk_tag\n");
    out.push_str("    movz x3, #1024, lsl #16\n");
    out.push_str("    add x3, x2, x3\n");
    out.push_str("    cmp x1, x3\n");
    out.push_str("    b.lo .L_arm_len_loop\n");
    out.push_str(".L_arm_len_chk_tag:\n");
    out.push_str("    movz w3, #0x0001\n");
    out.push_str("    movk w3, #0x5A11, lsl #16\n");
    out.push_str("    ldr w2, [x1, #-16]\n");
    ...
    emit_str_buf_ctx(out, "x20", "x21", "x9", os);
    out.push_str("    ldr x22, [x21]\n");
    out.push_str("    movz x9, #950000 & 0xffff\n");
    out.push_str("    movk x9, #950000 >> 16, lsl #16\n");
    out.push_str("    cmp x22, x9\n");
    out.push_str("    b.lo .L_arm64_bin_buf_ok\n");
    out.push_str("    mov x22, #0\n");
    out.push_str(".L_arm64_bin_buf_ok:\n");
    out.push_str("    add x20, x20, x22\n");
    out.push_str("    mov w9, #'0'\n");
    out.push_str("    strb w9, [x20]\n");
    out.push_str("    mov w9, #'b'\n");
    out.push_str("    strb w9, [x20, #1]\n");
    out.push_str("    mov x1, #2\n");
    out.push_str("    cbnz x19, .L_arm64_bin_nonzero\n");
    out.push_str("    mov w9, #'0'\n");
    out.push_str("    strb w9, [x20, #2]\n");
    out.push_str("    strb wzr, [x20, #3]\n");
    out.push_str("    add x22, x22, #4\n");
    out.push_str("    add x22, x22, #7\n");
    out.push_str("    and x22, x22, #-8\n");
    out.push_str("    str x22, [x21]\n");
    out.push_str("    mov x0, x20\n");
    out.push_str("    b .L_arm64_bin_done\n");
    out.push_str(".L_arm64_bin_nonzero:\n");
    out.push_str("    clz x2, x19\n");
    out.push_str("    mov x3, #63\n");
    out.push_str("    sub x2, x3, x2\n");
    out.push_str(".L_arm64_bin_loop:\n");
    out.push_str("    lsr x3, x19, x2\n");
    out.push_str("    and w3, w3, #1\n");
    out.push_str("    add w3, w3, #'0'\n");
    out.push_str("    strb w3, [x20, x1]\n");
    out.push_str("    add x1, x1, #1\n");
    out.push_str("    subs x2, x2, #1\n");
    out.push_str("    b.ge .L_arm64_bin_loop\n");
    out.push_str("    strb wzr, [x20, x1]\n");
    out.push_str("    add x1, x1, #1\n");
    out.push_str("    add x22, x22, x1\n");
    out.push_str("    add x22, x22, #7\n");
    out.push_str("    and x22, x22, #-8\n");
    out.push_str("    str x22, [x21]\n");
    out.push_str("    mov x0, x20\n");
    out.push_str(".L_arm64_bin_done:\n");
    out.push_str("    ldp x21, x22, [sp, #32]\n");
    out.push_str("    ldp x19, x20, [sp, #16]\n");
    out.push_str("    ldp x29, x30, [sp], #48\n");
    out.push_str("    ret\n\n");
    ...
    out.push_str(".L_arm64_runes_loop:\n");
    out.push_str("    cmp x23, x20\n");
    out.push_str("    b.ge .L_arm64_runes_done\n");
    out.push_str("    ldrb w0, [x19]\n");
    out.push_str("    cbz w0, .L_arm64_runes_done\n");
    out.push_str("    mov x1, #1\n");
    out.push_str("    cmp w0, #0x80\n");
    out.push_str("    b.lo .L_arm64_runes_len_ok\n");
    out.push_str("    and w2, w0, #0xE0\n");
    out.push_str("    cmp w2, #0xC0\n");
    out.push_str("    b.ne .L_arm64_runes_chk3\n");
    out.push_str("    mov x1, #2\n");
    out.push_str("    b .L_arm64_runes_len_ok\n");
    out.push_str(".L_arm64_runes_chk3:\n");
    out.push_str("    and w2, w0, #0xF0\n");
    out.push_str("    cmp w2, #0xE0\n");
    out.push_str("    b.ne .L_arm64_runes_chk4\n");
    out.push_str("    mov x1, #3\n");
    out.push_str("    b .L_arm64_runes_len_ok\n");
    out.push_str(".L_arm64_runes_chk4:\n");
    out.push_str("    and w2, w0, #0xF8\n");
    out.push_str("    cmp w2, #0xF0\n");
    out.push_str("    b.ne .L_arm64_runes_len_ok\n");
    out.push_str("    mov x1, #4\n");
    out.push_str(".L_arm64_runes_len_ok:\n");
    emit_str_buf_ctx(out, "x2", "x3", "x9", os);
    out.push_str("    ldr x4, [x3]\n");
    out.push_str("    movz x9, #950000 & 0xffff\n");
    out.push_str("    movk x9, #950000 >> 16, lsl #16\n");
    out.push_str("    cmp x4, x9\n");
    out.push_str("    b.lo .L_arm64_runes_buf_ok\n");
    out.push_str("    mov x4, #0\n");
    out.push_str(".L_arm64_runes_buf_ok:\n");
    out.push_str("    add x5, x2, x4\n");
    out.push_str("    mov x6, #0\n");
    out.push_str(".L_arm64_runes_copy_byte:\n");
    out.push_str("    cmp x6, x1\n");
    out.push_str("    b.ge .L_arm64_runes_copy_done\n");
    out.push_str("    ldrb w7, [x19, x6]\n");
    out.push_str("    strb w7, [x5, x6]\n");
    out.push_str("    add x6, x6, #1\n");
    out.push_str("    b .L_arm64_runes_copy_byte\n");
    out.push_str(".L_arm64_runes_copy_done:\n");
    out.push_str("    strb wzr, [x5, x1]\n");
    out.push_str("    add x6, x1, #1\n");
    out.push_str("    add x4, x4, x6\n");
    out.push_str("    add x4, x4, #7\n");
    out.push_str("    and x4, x4, #-8\n");
    out.push_str("    str x4, [x3]\n");
    out.push_str("    str x5, [x22, x23, lsl #3]\n");
