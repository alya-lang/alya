...
```powershell
wingetcreate new https://github.com/alya-lang/alya/releases/download/v0.0.15/alyac-v0.0.15-x86_64-windows.zip
```

### Method B: Manual PR
Copy `alyac.yaml` to the community repository under:
`manifests/a/Alya/alyac/0.0.15/Alya.alyac.yaml`
